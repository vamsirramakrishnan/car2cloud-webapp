<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewUser.aspx.cs" Inherits="ictlab.NewUser" %>
...
<table>
    ...
    <tr>
        <td><asp:Button ID="btnSendData" runat="server" Text="Gebruiker toevoegen" /></td>
    </tr>
</table>
</asp:Content>
